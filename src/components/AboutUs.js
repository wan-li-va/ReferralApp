...
const aboutUs = () => {
  return (
    <div className="page">
      <img alt="environmentally friendly" className="environment-img" src={require('../environmentally-friendly.png')}></img>
      <h2>Who is ReSHOE?</h2>
      ...
      <img alt="shoes" className="shoes" src={require('../amazon-fakes.png')} align="left"></img>
